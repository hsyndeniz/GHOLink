...
export interface SourceMinterInterface extends Interface {
  ...
  decodeFunctionResult(functionFragment: "approveGHO", data: BytesLike): Result;
...
export interface SourceMinter extends BaseContract {
  ...
  approveGHO: TypedContractMethod<[], [void], "nonpayable">;
